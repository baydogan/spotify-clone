export const HomeIcon = () => {
  return (
    <svg role="img" height="24" width="24" className="side-menu-icon group-hover:fill-white" viewBox="0 0 24 24">
...
export const HomeIconActive = () => {
  return (
    <svg role="img" height="24" width="24" className="side-menu-icon-active" viewBox="0 0 24 24">
...
export const AddIcon = () => {
  return (
    <svg role="img" height="12" width="12" aria-hidden="true" viewBox="0 0 16 16" className="fill-black">
...
export const SideMenuLikeIcon = () => {
  return (
    <svg
      ...
      aria-hidden="true"
      viewBox="0 0 16 16"
      className="fill-gray-300 group-hover:fill-white transition-all duration-300"
    >
...
export const PopupMenuIcon = () => {
  return (
    <svg role="img" height="16" width="16" viewBox="0 0 16 16" className="fill-white">
